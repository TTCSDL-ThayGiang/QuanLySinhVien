...
namespace Quanlysinhvien_v.GUI.SinhVien
{
    public partial class frmSinhVien : Form
    {
        ...
        {
            string createView = "create view chitiet_sv as select * from sinh_vien where ma_sinh_vien = '"+txtMaSinhVien.Text+"'";
            SqlCommand comcreateView = new SqlCommand(createView, con);
            comcreateView.ExecuteNonQuery();
